...
//    <td>{level}</td>
    ...
    private final Map<String, App> apps = new TreeMap<>(Map.ofEntries(
            app("Client 1", "java", "-cp", CLASSPATH, "rmi.Client", "client-1", "lastClient-1", "345567", "2", "false"),
            app("Client 2", "java", "-cp", CLASSPATH, "rmi.Client", "client-1", "lastClient-1", "345567", "3", "false"),
            app("Client 3", "java", "-cp", CLASSPATH, "rmi.Client", "client-3", "lastClient-3", "345568", "2", "true"),
